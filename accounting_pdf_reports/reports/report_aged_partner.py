...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(self, account_type, date_from, target_move, period_length,data):
        print("hi report ..",data)
        ...
        if reconciled_after_date:
            ...
            # print(reconciled_after_date," hi..")
        arg_list += (date_from, tuple(company_ids))
        # print(company_ids, " hi..")
        # print(data["form"]["partner_id"], " hi..")
        # print(date_from , " hi..")

        ids=[]
        ids.append( (data["form"]["partner_id"]))
        print(ids)
        id= tuple(ids )
        print(id)
        arg_list += id
        # arg_list += ( tuple((data["form"]["partner_id"])))

        print("hi list ..", arg_list)
        query = '''
    ...
    def _get_report_values(self, docids, data=None):
        ...
        movelines, total, dummy = self._get_partner_move_lines(account_type, date_from, target_move, data['form']['period_length'],data)
        return {
            'doc_ids': self.ids,
            'doc_model': model,
            'data': data['form'],
