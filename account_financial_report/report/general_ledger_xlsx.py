    ...
    def _get_report_columns(self, report):
        res = {
            ...
            13: {'header': _('sl#'),
                 'field': 'x_sale_id',
                 'width': 14},
            14: {'header': _('Type of car'),
                 'field': 'x_studio_car_type_name',
                 'width': 14},
            15: {'header': _('Plate#'),
                 'field': 'x_studio_plate_num',
                 'width': 14},
            16: {'header': _('clam#'),
                 'field': 'x_studio_claim_num',
                 'width': 14},
            17: {'header': _('amount before vat'),
                 'field': 'x_amount_untaxed',
                 'type': 'amount',
                 'width': 14},
            18: {'header': _('vat'),
                 'field': 'x_amount_tax',
